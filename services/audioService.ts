/**
 * Audio service to synthesize powerful, cinematic firework sounds and subtle UI feedback using Web Audio API.
 */
...
/**
 * Synthesizes a subtle tick sound for the timer.
 */
export const playTick = () => {
  try {
    ...
    // Use a high frequency for a "clean" mechanical tick feel
    osc.type = 'sine';
    osc.frequency.setValueAtTime(1200, now);
    
    // Very short decay
    g.gain.setValueAtTime(0.08 * currentVolume, now);
